...
export default class MediaBrowserCommand extends Command {
  ...
  execute() {
    ...
    editor.model.change((writer) => {
      ...
      const feat =
        "alwaysRaised=yes,dependent=yes,height=" +
        editorWin.screen.height +
        ",location=no,menubar=no," +
        "minimizable=no,modal=yes,resizable=yes,scrollbars=yes,toolbar=no,width=" +
